...
public class MainActivity extends AppCompatActivity implements CompoundButton.OnCheckedChangeListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        isItalic = false;
        fonts = new Typeface[]{
                ResourcesCompat.getFont(MainActivity.this, R.font.a_300_regular),
                ResourcesCompat.getFont(MainActivity.this, R.font.aa_sameer_almas_regular),
                ResourcesCompat.getFont(MainActivity.this, R.font.aa_sameer_divangiry_regular),
                ResourcesCompat.getFont(MainActivity.this, R.font.aa_sameer_qamri_regular),
                ResourcesCompat.getFont(MainActivity.this, R.font.aa_sameer_rafiya_unicode_regular),
                ResourcesCompat.getFont(MainActivity.this, R.font.aa_sameer_zikran_regular),
        ...
        saveImage.setOnClickListener(v1 -> {
            if (!checkPermission()) {
                floatingActionsMenu.collapse();
                Toast.makeText(MainActivity.this, "Please allow access to storage then try again", Toast.LENGTH_LONG).show();
                ...
                Notification.create(MainActivity.this, prefs.getStringEntry("filename"), uri);
        ...
        backgroundColorStyle.setOnClickListener(v -> {
            floatingActionsMenu.collapse();
            backgroundStyle = new Dialog(MainActivity.this, R.style.WideDialog);
        ...
        textStyle.setOnClickListener(v -> {
            floatingActionsMenu.collapse();
            fontStyle = new Dialog(MainActivity.this, R.style.WideDialog);
    ...
    public void showTextColorPickDialog() {
        textColorPicker = new Dialog(MainActivity.this, R.style.WideDialog);
    ...
    public void showLeftGradientBackgroundColorPickDialog() {
        leftGradientDialog = new Dialog(MainActivity.this, R.style.WideDialog);
    ...
    public void showRightGradientBackgroundColorPickDialog() {
        rightGradientDialog = new Dialog(MainActivity.this, R.style.WideDialog);
    ...
    public Uri saveAndUploadFileOnline() {
        ...
        String filepath = uid + "/Images/" + prefs.getStringEntry("filename") + ".jpg";

        FirebaseStorage firebaseStorage = FirebaseStorage.getInstance();
        StorageReference storageReference = firebaseStorage.getReference();
        DatabaseReference ref = FirebaseDatabase.getInstance().getReference().child(uid).child("Images");

        Uri path = ImageMaker.saveBitMap(MainActivity.this, root);
        ...
        if (path != null) {
            mountainImagesRef.putFile(path).addOnCompleteListener(task -> {
                if (task.isSuccessful()) {
                    mountainImagesRef.getDownloadUrl().addOnSuccessListener(uri -> ref.child(prefs.getStringEntry("filename")).setValue(uri.toString()));
